...
public class UnidadesControllerTest {
	...
	public void testModificar() throws Exception {
		URI uri = new URI("/unidades/2");
		String json = "{\"propietario\": \"Ramalho\"}";
